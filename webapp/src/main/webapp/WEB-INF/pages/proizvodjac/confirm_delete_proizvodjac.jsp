...
<body>
	...
	<div class='container'>
		<h3>Da li ste sigurni da zelite da obrisete proizvodjaca?</h3>
		<form method='post' action='/webapp/application/proizvodjac/delete'>
			<div>
			...
			<div>
				<label for='maticniBroj'>Maticni broj:</label> <br> <input
					type='text' name='maticniBroj' readonly="readonly" value='${proizvodjac.maticniBroj }'>
			</div>
			<div>
				<label for='adresa'>Adresa:</label> <br> <input type='text'
					name='adresa' readonly="readonly" value='${proizvodjac.adresa }'>
			</div>
			<div><label for='mesto'>Mesto:</label>
				<input type='text' name='mesto' readonly="readonly" value='${proizvodjac.mesto.naziv }'>
			</div>
			<input type='submit' value='Delete' name='btn-action'>
